This is my implementation of a Word2Vec neural network. you will need to grab your own datasets if you want to run this. I've tried to keep it as simple as possible.
